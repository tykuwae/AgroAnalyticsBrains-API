...
def getArimaTempratureParameters(stationId):
    # Get station Infos
    ...
    print('*************************************************************')
    print('\n')
    print('-------------- ARIMA Temperature Parameters -----------------')
    print('\n')
...
def PredictARIMATemperature(stationId, ARIMA_p, ARIMA_d, ARIMA_q):
    ...
    d=int(ARIMA_d)
    q=int(ARIMA_q)
    arima = sm.tsa.SARIMAX(ts_train, order=(p,d,q), enforce_stationarity=False, enforce_invertibility=False)
