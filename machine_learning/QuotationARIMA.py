...
def getArimaQuotationParameters(uf_id, product_id):
    ...
    print('*************************************************************')
    print('\n')
    print('--------------- ARIMA Quotation Parameters ------------------')
    print('\n')
...
def PredictARIMAQuotation(uf_id, product_id, ARIMA_p, ARIMA_d, ARIMA_q):
    ...
    pred_end = ts_test.index[-1] + datetime.timedelta(days=90)
